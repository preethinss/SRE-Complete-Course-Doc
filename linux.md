...
* Swap Space Usage: Swap space is a portion of the hard drive/disk that the operating system uses as virtual memory when the physical RAM is full. It's slower than RAM, so using swap space can lead to reduced performance.
...
# Scenario Explained
Generating Load: By running hey -n 100 -c 10 application_url, you are generating 100 requests to your application with 10 concurrent workers. This simulates multiple users accessing your application simultaneously.
